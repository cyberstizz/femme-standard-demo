...
export const CATEGORIES = ['Dresses', 'Tops', 'Bottoms', 'Outerwear', 'Bags', 'Shoes']

const p = (id, title, category, size, condition, price, sil, extra = {}) => ({
  id,
  title,
  category,
  size,
...
export const SEED_PIECES = [
  p('fs-01', 'Black satin midi dress', 'Dresses', 'M', 'Excellent', 68, 'dress', {
  ...
  p('fs-02', 'Structured leather tote', 'Bags', 'One size', 'Like new', 145, 'bag', {
  ...
  p('fs-03', 'Gold strap heel', 'Shoes', '8', 'Very good', 54, 'heel', {
  ...
  p('fs-04', 'Cream wide-leg trouser', 'Bottoms', 'S', 'Excellent', 48, 'pants', {
    views: 22, saves: 4,
    measurements: { waist: '13 in', inseam: '30 in', rise: '11 in' },
    fabric: 'Crepe',
  }),
  p('fs-05', 'Black column gown', 'Dresses', 'L', 'Like new', 132, 'dress', {
  ...
  p('fs-06', 'Ribbed knit shell', 'Tops', 'M', 'Very good', 32, 'top', {
    views: 14, saves: 2,
    measurements: { bust: '17 in', length: '22 in' },
    fabric: 'Cotton rib',
  }),
  p('fs-07', 'Camel wrap coat', 'Outerwear', 'M', 'Excellent', 118, 'blazer', {
    views: 47, saves: 15,
    measurements: { shoulder: '16 in', bust: '19 in', length: '44 in' },
    fabric: 'Wool blend',
  }),
  p('fs-08', 'Pleated midi skirt', 'Bottoms', 'S', 'Like new', 44, 'skirt', {
    views: 19, saves: 5,
    measurements: { waist: '13 in', length: '31 in' },
    fabric: 'Poly satin',
  }),
  p('fs-09', 'Silk slip in champagne', 'Dresses', 'S', 'Excellent', 76, 'dress', {
    views: 38, saves: 12,
    measurements: { bust: '16 in', waist: '15 in', length: '46 in' },
    fabric: 'Silk charmeuse',
  }),
  p('fs-10', 'Quilted shoulder bag', 'Bags', 'One size', 'Very good', 88, 'bag', {
    views: 31, saves: 8,
    measurements: { width: '10 in', height: '7 in', drop: '11 in' },
    fabric: 'Lambskin',
    notes: 'Chain shows light wear. Clasp is tight.',
  }),
  p('fs-11', 'Ivory linen blazer', 'Outerwear', 'S', 'Excellent', 92, 'blazer', {
    views: 26, saves: 7,
    measurements: { shoulder: '15 in', bust: '18 in', length: '27 in' },
    fabric: 'Linen',
  }),
  p('fs-12', 'Black leather pump', 'Shoes', '7.5', 'Like new', 65, 'heel', {
    views: 20, saves: 5,
    measurements: { heel: '4 in' },
    fabric: 'Calf leather',
  }),
  p('fs-13', 'Off-shoulder crop top', 'Tops', 'XS', 'Very good', 26, 'top', {
    views: 11, saves: 1,
    measurements: { bust: '15 in', length: '15 in' },
    fabric: 'Cotton poplin',
  }),
  p('fs-14', 'High-rise straight jean', 'Bottoms', 'M', 'Good', 38, 'pants', {
    views: 24, saves: 6,
    measurements: { waist: '15 in', inseam: '31 in', rise: '12 in' },
    fabric: 'Rigid denim',
    notes: 'Honest wear at the back pocket edges. Priced for it.',
  }),
  p('fs-15', 'Sequin mini dress', 'Dresses', 'M', 'Excellent', 84, 'dress', {
    views: 44, saves: 14,
    measurements: { bust: '17 in', waist: '14 in', length: '33 in' },
    fabric: 'Sequin on mesh',
  }),
  p('fs-16', 'Woven raffia clutch', 'Bags', 'One size', 'Like new', 42, 'bag', {
    views: 16, saves: 3,
    measurements: { width: '11 in', height: '7 in' },
    fabric: 'Raffia',
  }),
  p('fs-17', 'Black wool trouser', 'Bottoms', 'L', 'Excellent', 52, 'pants', {
    views: 13, saves: 2,
    measurements: { waist: '16 in', inseam: '30 in', rise: '12 in' },
    fabric: 'Tropical wool',
  }),
  p('fs-18', 'Satin blouse in bronze', 'Tops', 'L', 'Very good', 34, 'top', {
    views: 9, saves: 1,
    measurements: { bust: '20 in', length: '25 in' },
    fabric: 'Satin',
  }),
  p('fs-19', 'Strappy gold sandal', 'Shoes', '9', 'Excellent', 48, 'heel', {
    views: 21, saves: 4,
    measurements: { heel: '2.5 in' },
    fabric: 'Metallic leather',
  }),
  p('fs-20', 'Trench in stone', 'Outerwear', 'L', 'Very good', 96, 'blazer', {
    views: 29, saves: 9,
    measurements: { shoulder: '17 in', bust: '21 in', length: '46 in' },
    fabric: 'Cotton gabardine',
  }),
  p('fs-21', 'Bodycon knit dress', 'Dresses', 'XS', 'Like new', 58, 'dress', {
    views: 33, saves: 11,
    measurements: { bust: '15 in', waist: '13 in', length: '38 in' },
    fabric: 'Ponte knit',
  }),
  p('fs-22', 'Cropped denim jacket', 'Outerwear', 'M', 'Good', 46, 'blazer', {
    views: 18, saves: 3,
    measurements: { shoulder: '16 in', bust: '19 in', length: '20 in' },
    fabric: 'Denim',
    notes: 'Softened wash from wear. No damage.',
  }),
  p('fs-23', 'Tiered maxi skirt', 'Bottoms', 'M', 'Excellent', 56, 'skirt', {
    views: 15, saves: 4,
  ...
  { ...p('fs-s1', 'Red halter gown', 'Dresses', 'S', 'Excellent', 110, 'dress'), status: 'sold', soldInDays: 2, views: 88, saves: 24 },
  { ...p('fs-s2', 'Black blazer dress', 'Dresses', 'M', 'Like new', 74, 'dress'), status: 'sold', soldInDays: 1, views: 71, saves: 19 },
  { ...p('fs-s3', 'Croc-effect top handle', 'Bags', 'One size', 'Excellent', 130, 'bag'), status: 'sold', soldInDays: 4, views: 64, saves: 16 },
  { ...p('fs-s4', 'Suede ankle boot', 'Shoes', '8', 'Very good', 58, 'heel'), status: 'sold', soldInDays: 6, views: 40, saves: 8 },

  // Half-listed
  { ...p('fs-d1', 'Gold mesh top', 'Tops', 'M', 'Excellent', 0, 'top'), status: 'draft' },
  { ...p('fs-d2', 'Printed wrap dress', 'Dresses', 'L', 'Very good', 0, 'dress'), status: 'draft' },
]
